...
from transformers import (AutoConfig, AutoModelForCausalLM, GenerationConfig,
                          MistralForSequenceClassification, PretrainedConfig)
...
#         elif "Llama3-8B-RewardModel" in config.model.path:
#             try:
...
#                     torch_dtype="auto",
#                 )
#                 print("Successfully loaded as LlamaForSequenceClassification")
#                 is_value_model = True
...
#                         torch_dtype="auto",
#                     )
#                     print("Successfully loaded as LlamaForTokenClassification")
#                     is_value_model = True
                    
#                 except Exception as e2:
#                     print(f"Failed to load as classification model, falling back to base model")
#                     print(f"SequenceClassification error: {e1}")
#                     print(f"TokenClassification error: {e2}")
...
#             # if "score.weight" in state_dict and "lm_head.weight" not in state_dict:
#             #     state_dict["lm_head.weight"] = state_dict["score.weight"]
