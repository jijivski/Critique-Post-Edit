...
class FSDPCheckpointManager(BaseCheckpointManager):
    ...
    def load_checkpoint(self, local_path: str, hdfs_path: str = None, del_local_after_load=False):
        ...
        # # Determine the device to map to
        # if is_cuda_available:
        #     map_location = f'cuda:{torch.cuda.current_device()}'
        # else:
        #     map_location = 'cpu'

        # model_state_dict = torch.load(local_model_path, weights_only=False, map_location=map_location)
        # optimizer_state_dict = torch.load(local_optim_path, weights_only=False, map_location=map_location)
        # extra_state_dict = torch.load(local_extra_state_path, weights_only=False, map_location=map_location)
